...
class TestRejectingPickupTime():
  ...
  def test_rejectingPickupTime(self):
    ...
    dropdown = self.driver.find_element(By.ID, "validationTooltip08")
    dropdown.find_element(By.XPATH, "//option[. = 'Afternoon (2:00 PM - 5:00 PM)']").click()
    self.driver.find_element(By.ID, "validationTooltip08").click()
    ...
    assert value == "Awaiting Pickup Approval by Organization"
